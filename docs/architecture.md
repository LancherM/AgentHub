...
the TaskBrief before planned execution nodes are scheduled as primary TaskRuns.
...
audit-safe. A proposed amendment is stored as a `proposed` PlanGraph version and
